...
/** @type {string} */
const CACHE_VERSION = '1781732423|7147377102';
/** @type {string} */
const CACHE_PREFIX = 'SHU_game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SHU_game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SHU_game.html","SHU_game.js","SHU_game.offline.html","SHU_game.icon.png","SHU_game.apple-touch-icon.png","SHU_game.audio.worklet.js","SHU_game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SHU_game.wasm","SHU_game.pck"];
